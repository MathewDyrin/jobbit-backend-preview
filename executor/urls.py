...
router.register('portfolio', viewset=views.ExecutorPortfolioViewSet, basename='portfolio')
...
router.register('portfolio_album', viewset=views.ExecutorPortfolioAlbumViewSet, basename='portfolio_album')
